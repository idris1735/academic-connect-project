    ...
    <footer className='bg-gray-900 text-white py-12'>
      <div className='max-w-6xl mx-auto px-4'>
        <div className='grid md:grid-cols-3 gap-8'>
          ...
          <div>
            ...
            <p className='text-gray-400 mb-4'>
              Connecting researchers worldwide to advance scientific discovery.
            </p>
          ...
          <div>
            ...
            <ul className='space-y-2 text-gray-400'>
              <li>123 Academic Ave, Research City, 12345</li>
              <li>+1 (234) 567-890</li>
              <li>
                <a
        ...
        <div className='border-t border-gray-800 mt-8 pt-8 text-center text-gray-400'>
          <p>
            &copy; {new Date().getFullYear()} AcademicConnect, a project of
            Oasis Premium Limited. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
