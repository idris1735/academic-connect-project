...
const conversations = [
  ...
  },
  {
    ...
    lastMessage:
      'Dr. Smith: Let\'s discuss the latest findings in our next session.',
  ...
  },
  {
    ...
    lastMessage:
      'Prof. Johnson: The deadline for submissions has been extended.',
                  ...
                  <div className='flex items-center justify-between'>
                    <h4
                      className={`font-semibold truncate ${
                        conversation.unread ? 'text-[#6366F1]' : 'text-gray-900'
                      }`}
                    >
              ...
              >
                ...
                <div className='flex-1 min-w-0'>
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='text-xs text-gray-500'>
                      {format(new Date(room.lastUpdate), 'MMM d')}
                    </span>
                  </div>
